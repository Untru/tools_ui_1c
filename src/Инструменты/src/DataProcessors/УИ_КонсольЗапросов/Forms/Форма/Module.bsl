...
&НаКлиенте
Процедура УИ_ВставитьПредставлениеЗапроса(Команда)
	ОписаниеОповещенияОЗакрытии = Новый ОписаниеОповещения("УИ_КонструкторПредставленийЗавершение", ЭтотОбъект);
...
// 
// Возвращаемое значение:
//  Структура - У и заменить запросы к представлениям виртуальных таблиц на сервере:
// * ТекстЗапроса - Строка - 
// * ПараметрыЗапроса - Структура - 
&НаСервере
Функция УИ_ЗаменитьЗапросыКПредставлениямВиртуальныхТаблицНаСервере(ТекстЗапроса)
...
&НаСервере
Функция УИ_ПараметрыЗапросаВПараметрыЗапросаФормы(ПараметрыЗапроса)
